    ...
    case 4:
        {
            ...
            glViewportIndexedf( 1,  w2, 0,  w2, h2 ); // pour le viewport 1
            glScissorIndexed(   1,  w2, 0,  w2, h2 );
            glViewportIndexedf( 2,  0,  h2, w2, h2 ); // pour le viewport 2
            glScissorIndexed(   2,  0,  h2, w2, h2 );
            glViewportIndexedf( 3,  w2, h2, w2, h2 ); // pour le viewport 3
...
void FenetreTP::clavier( TP_touche touche )
{
    ...
    case TP_n: // modifier le nombre de vues
        if ( ++Etat::nvues > 3 ) Etat::nvues = 1;
